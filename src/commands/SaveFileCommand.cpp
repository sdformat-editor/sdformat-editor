...
bool SaveFileCommand::execute_undo()
{
  return this->is_undoable();
}

bool SaveFileCommand::execute_redo()
{
  return this->is_redoable();
}

bool SaveFileCommand::is_threaded() 
{
  return true;
}

bool SaveFileCommand::is_undoable()
{
  return false;
}

bool SaveFileCommand::is_redoable()
{
  return true;
}
