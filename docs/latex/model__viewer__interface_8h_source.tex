...
\DoxyCodeLine{00028\ \{}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00033\ \ \ \ \ \textcolor{comment}{//\ \ multiple\ times\ (unlike\ the\ GUI),\ which\ should\ terminate\ the\ program\ if\ it\ closes.}}
\DoxyCodeLine{00036\ \ \ \ \ \textcolor{keyword}{public}:\ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classModelViewerI_ac6e6cc65e2be33a692061c2b4e02f773}{Initialize}}(\textcolor{keyword}{const}\ std::vector<std::string>\ \&cad\_files,\ \textcolor{keywordtype}{bool}\ \&success)\ =\ 0;}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00040\ \ \ \ \ \textcolor{keyword}{public}:\ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classModelViewerI_a6ee962a2e2820c6af9a6b58df7f37501}{Update}}()\ =\ 0;}
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ \};}
\DoxyCodeLine{00043\ }
